...
public class Personagem {
    ...
    public String nome;
    public String classe; // assassino, atirador, mago, tank
    ...
    public void atacar(){
        ...
        System.out.println(nome+" atacou com sua armadura de espinhos voadores, causando "+forca+" de dano");       
        }
    }
    ...
    if (classe.equals("mago")) {
        if (mana >= 25) {
            System.out.println(nome + " usou Cristais Uivantes! Causou 25 de dano!");
            mana -= 50;
            forca = 25;
        } else {
    ...
    public void mostrarStatus(){
        ...
        if(classe.equals("mago")){
            System.out.println("Forca: 15");
        }else if(classe.equals("atirador")){
            System.out.println("Forca: 25");
        }else if(classe.equals("tank")){
            System.out.println("Forca: 5");
        }
        System.out.println("------------------------------");
